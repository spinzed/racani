...
class PointLight : public Light {
  public:
    ...
    PointLight(glm::vec3 position, glm::vec3 intensity, glm::vec3 color)
        : Light(position, intensity, color), cb(1024, 1024, true) {}
    std::vector<glm::mat4> transforms = {lookAtPosX, lookAtNegX, lookAtPosY, lookAtNegY, lookAtPosZ, lookAtNegZ};
